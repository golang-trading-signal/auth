...
func Test_sould_fail_when_password_length_is_less_than_6(t *testing.T) {
	// Arrange
...
func Test_sould_fail_when_no_lower_char_in_password(t *testing.T) {
	// Arrange
	request := dto.SignupRequest{
		Email:    "sample@sample.com",
		Password: "123456789B",
...
func Test_sould_fail_when_no_upper_char_in_password(t *testing.T) {
	// Arrange
	request := dto.SignupRequest{
		Email:    "sample@sample.com",
		Password: "123456789a",
...
func Test_sould_fail_when_no_int_in_password(t *testing.T) {
	// Arrange
	request := dto.SignupRequest{
		Email:    "sample@sample.com",
...
func Test_sould_succeed_when_password_contains_everything(t *testing.T) {
	// Arrange
	request := dto.SignupRequest{
		Email:    "sample@sample.com",
...
func Test_sould_fail_when_invalid_email_is_used(t *testing.T) {
	// Arrange
	request := dto.SignupRequest{
		Email:    "sample",
		Password: "123456789aA!",
